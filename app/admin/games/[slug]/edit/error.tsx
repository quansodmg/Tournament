...
export default function AdminEditGameError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("Admin edit game error:", error)
  }, [error])
      ...
      <Card className="max-w-3xl mx-auto border-red-200 bg-red-50 text-black">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-red-600">Error Editing Game</CardTitle>
          </div>
          <CardDescription className="text-red-700">
            We encountered an issue while loading the game editor.
          </CardDescription>
        </CardHeader>
        <CardContent>
