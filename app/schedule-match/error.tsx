      ...
      <Card className="border-red-200 bg-red-50">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-red-600">Error Scheduling Match</CardTitle>
          </div>
          <CardDescription>We encountered an issue while loading the match scheduling form.</CardDescription>
        </CardHeader>
        <CardContent>
